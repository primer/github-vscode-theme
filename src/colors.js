...
const lightColorblindColors = require("@primer/primitives/dist/json/colors/light_protanopia.json");
const hcColors = require("@primer/primitives/dist/json/colors/dark_high_contrast.json");
const darkColorblindColors = require("@primer/primitives/dist/json/colors/dark_protanopia.json");
