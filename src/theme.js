...
function getTheme({ theme, name }) {
  const themes = (options) => options[theme]; // Usage: themes({ light: "lightblue", protanopia: "lightblue", dark: "darkblue", dark_protanopia: "darkblue," dimmed: "royalblue", hc: "blue" })
  ...
  return {
    ...
    colors: {
      ...
      "editor.findMatchBackground"          : themes({ light: "#bf8700", protanopia: "#bf8700", dark: "#ffd33d44", dark_protanopia: "#ffd33d44", dimmed: "#ffd33d44", hc: "#ffd33d44"   }),
      "editor.findMatchHighlightBackground" : themes({ light: "#ffdf5d66", protanopia: "#ffdf5d66", dark: "#ffd33d22", dark_protanopia: "#ffd33d22", dimmed: "#ffd33d22", hc: "#ffd33d22" }),
      "editor.linkedEditingBackground"      : themes({ light: "#0366d611", protanopia: "#0366d611", dark: "#3392FF22", dark_protanopia: "#3392FF22", dimmed: "#3392FF22", hc: "#3392FF22" }),
      "editor.inactiveSelectionBackground"  : themes({ light: "#0366d611", protanopia: "#0366d611", dark: "#3392FF22", dark_protanopia: "#3392FF22", dimmed: "#3392FF22", hc: "#addcff66" }),
      "editor.selectionBackground"          : themes({ light: "#0366d625", protanopia: "#0366d625", dark: "#3392FF44", dark_protanopia: "#3392FF44", dimmed: "#3392FF44", hc: "#addcff99" }),
      "editor.selectionHighlightBackground" : themes({ light: "#34d05840", protanopia: "#34d05840", dark: "#17E5E633", dark_protanopia: "#17E5E633", dimmed: "#17E5E633", hc: "#17E5E633" }),
      "editor.selectionHighlightBorder"     : themes({ light: "#34d05800", protanopia: "#34d05800", dark: "#17E5E600", dark_protanopia: "#17E5E600", dimmed: "#17E5E600", hc: "#17E5E600" }),
      "editor.wordHighlightBackground"      : themes({ light: "#34d05800", protanopia: "#34d05800", dark: "#17E5E600", dark_protanopia: "#17E5E600", dimmed: "#17E5E600", hc: "#17E5E600" }),
      "editor.wordHighlightStrongBackground": themes({ light: "#34d05800", protanopia: "#34d05800", dark: "#17E5E600", dark_protanopia: "#17E5E600", dimmed: "#17E5E600", hc: "#17E5E600" }),
      "editor.wordHighlightBorder"          : themes({ light: "#24943e99", protanopia: "#24943e99", dark: "#17E5E699", dark_protanopia: "#17E5E699", dimmed: "#17E5E699", hc: "#17E5E699" }),
      "editor.wordHighlightStrongBorder"    : themes({ light: "#24943e50", protanopia: "#24943e50", dark: "#17E5E666", dark_protanopia: "#17E5E666", dimmed: "#17E5E666", hc: "#17E5E666" }),
      "editorBracketMatch.background"       : themes({ light: "#34d05840", protanopia: "#34d05840", dark: "#17E5E650", dark_protanopia: "#17E5E650", dimmed: "#17E5E650", hc: "#17E5E650" }),
      "editorBracketMatch.border"           : themes({ light: "#34d05800", protanopia: "#34d05800", dark: "#17E5E600", dark_protanopia: "#17E5E600", dimmed: "#17E5E600", hc: "#17E5E600" }),
      ...
      "scrollbar.shadow"                : themes({ light: "#6a737d33", protanopia: "#6a737d33", dark: "#0008", dark_protanopia: "#0008", dimmed: "#0008" }),
      "scrollbarSlider.background"      : themes({ light: "#959da533", protanopia: "#959da533", dark: "#484F5833", dark_protanopia: "#484F5833", dimmed: "#484F5833", hc: "#484F5833" }),
      "scrollbarSlider.hoverBackground" : themes({ light: "#959da544", protanopia: "#959da544", dark: "#484F5844", dark_protanopia: "#484F5844", dimmed: "#484F5844", hc: "#484F5844" }),
      "scrollbarSlider.activeBackground": themes({ light: "#959da588", protanopia: "#959da588", dark: "#484F5888", dark_protanopia: "#484F5888", dimmed: "#484F5888", hc: "#484F5888" }),
      "editorOverviewRuler.border"      : themes({ light: scale.white, protanopia: scale.white, dark: scale.black, dark_protanopia: scale.black, dimmed: scale.black, hc: scale.black }),
      ...
      "editor.stackFrameHighlightBackground"       : themes({ light: "#ffd33d33", protanopia: "#ffd33d33", dark: "#D2992225", dark_protanopia: "#D2992225", dimmed: "#C6902625", hc: "#C6902625" }), // needs opacity (yellow)
      "editor.focusedStackFrameHighlightBackground": themes({ light: "#28a74525", protanopia: "#28a74525", dark: "#3FB95025", dark_protanopia: "#3FB95025", dimmed: "#2b6a3033", hc: "#2b6a3033" }), // needs opacity (green)

      "peekViewEditor.matchHighlightBackground": themes({ dark: "#ffd33d33", dark_protanopia: "#ffd33d33", dimmed: "#ffd33d33", hc: "#ffd33d33" }),
      "peekViewResult.matchHighlightBackground": themes({ dark: "#ffd33d33", dark_protanopia: "#ffd33d33", dimmed: "#ffd33d33", hc: "#ffd33d33" }),
      "peekViewEditor.background"              : themes({ dark: "#0d111788", dark_protanopia: "#0d111788", dimmed: "#0d111788", hc: "#0d111788" }),
      "peekViewResult.background"              : themes({ dark: scale.gray[9], dark_protanopia: scale.gray[9], dimmed: scale.gray[9], hc: scale.gray[9] }),
    ...
    tokenColors: [
      {
        ...
        settings: {
          foreground: themes({ light: scale.gray[5], protanopia: scale.gray[5], dark: scale.gray[3], dark_protanopia: scale.gray[3], dimmed: scale.gray[3], hc: scale.gray[3] }),
        },
      },
      {
        scope: [
        ...
        settings: {
          foreground: themes({ light: scale.blue[6], protanopia: scale.blue[6], dark: scale.blue[2], dark_protanopia: scale.blue[2], dimmed: scale.blue[2], hc: scale.blue[2] }),
        },
      },
      {
        scope: [
        ...
        settings: {
          foreground: themes({ light: scale.orange[6], protanopia: scale.orange[6], dark: scale.orange[2], dark_protanopia: scale.orange[6], dimmed: scale.orange[2], hc: scale.orange[2] }),
        },
      },
      {
        scope: [
      ...
      },
      {
        ...
        "settings": {
          foreground: themes({ light: scale.purple[5], protanopia: scale.purple[5], dark: scale.purple[2], dark_protanopia: scale.purple[2], dimmed: scale.purple[2], hc: scale.purple[2] }),
        }
      },
      {
        "scope": [
        ...
        settings: {
          foreground: themes({ light: scale.green[6], protanopia: scale.green[6], dark: scale.green[1], dark_protanopia: scale.green[1], dimmed: scale.green[1], hc: scale.green[1] }),
        },
      },
      {
        scope: "keyword",
        settings: {
          foreground: themes({ light: scale.red[5], protanopia: scale.red[5], dark: scale.red[3], dark_protanopia: scale.red[3], dimmed: scale.red[3], hc: scale.red[3] }),
        },
      },
      {
      ...
      },
      {
        ...
        settings: {
          foreground: themes({ light: scale.blue[8], protanopia: scale.blue[8], dark: scale.blue[1], dark_protanopia: scale.blue[1], dimmed: scale.blue[1], hc: scale.blue[1] }),
        },
      },
      {
        scope: "support",
      ...
      },
      {
        scope: "variable",
        settings: {
          foreground: themes({ light: scale.orange[6], protanopia: scale.orange[6], dark: scale.orange[2], dark_protanopia: scale.orange[2], dimmed: scale.orange[2], hc: scale.orange[2] }),
        },
      },
      {
      ...
      },
      {
        ...
        settings: {
          fontStyle: "italic",
          foreground: themes({ light: scale.red[7], protanopia: scale.red[7], dark: scale.red[2], dark_protanopia: scale.red[7], dimmed: scale.red[2], hc: scale.red[2] }),
        },
      },
      {
        ...
        settings: {
          fontStyle: "italic",
          foreground: themes({ light: scale.red[7], protanopia: scale.red[7], dark: scale.red[2], dark_protanopia: scale.red[2], dimmed: scale.red[2], hc: scale.red[2] }),
        },
      },
      {
      ...
      },
      {
        ...
        settings: {
          ...
          background: themes({ light: scale.red[5], protanopia: scale.red[5], dark: scale.red[3], dark_protanopia: scale.red[3], dimmed: scale.red[3], hc: scale.red[3] }),
          foreground: themes({ light: scale.gray[0], protanopia: scale.gray[0], dark: scale.gray[9], dark_protanopia: scale.gray[9], dimmed: scale.gray[9], hc: scale.gray[9] }),
          content: "^M",
        },
      },
      {
      ...
      },
      {
        ...
        settings: {
          background: themes({ light: scale.red[0], protanopia: scale.red[0], dark: scale.red[9], dark_protanopia: scale.red[9], dimmed: scale.red[9], hc: scale.red[9] }),
          foreground: themes({ light: scale.red[7], protanopia: scale.red[7], dark: scale.red[2], dark_protanopia: scale.red[2], dimmed: scale.red[2], hc: scale.red[2] }),
        },
      },
      {
        ...
        settings: {
          background: themes({ light: scale.green[0], protanopia: scale.green[0], dark: scale.green[9], dark_protanopia: scale.green[9], dimmed: scale.green[9], hc: scale.green[9] }),
          foreground: themes({ light: scale.green[6], protanopia: scale.green[6], dark: scale.green[1], dark_protanopia: scale.green[1], dimmed: scale.green[1], hc: scale.green[1] }),
        },
      },
      {
        ...
        settings: {
          background: themes({ light: scale.orange[1], protanopia: scale.orange[1], dark: scale.orange[8], dark_protanopia: scale.orange[8], dimmed: scale.orange[8], hc: scale.orange[8] }),
          foreground: themes({ light: scale.orange[6], protanopia: scale.orange[6], dark: scale.orange[2], dark_protanopia: scale.orange[2], dimmed: scale.orange[2], hc: scale.orange[2] }),
        },
      },
      {
        ...
        settings: {
          foreground: themes({ light: scale.gray[1], protanopia: scale.gray[1], dark: scale.gray[8], dark_protanopia: scale.gray[8], dimmed: scale.gray[8], hc: scale.gray[8] }),
          background: themes({ light: scale.blue[6], protanopia: scale.blue[6], dark: scale.blue[2], dark_protanopia: scale.blue[2], dimmed: scale.blue[2], hc: scale.blue[2] }),
        },
      },
      {
      ...
      },
      {
        ...
        settings: {
          foreground: themes({ light: scale.gray[6], protanopia: scale.gray[6], dark: scale.gray[3], dark_protanopia: scale.gray[3], dimmed: scale.gray[3], hc: scale.gray[3] }),
        },
      },
      {
