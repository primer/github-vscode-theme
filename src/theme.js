...
function getTheme({ theme, name }) {
  ...
  return {
    ...
    colors: {
      ...
      "statusBar.debuggingForeground"    : color.danger.fg,
      "statusBar.debuggingBackground"    : color.danger.subtle,
      "statusBarItem.prominentBackground": color.neutral.muted,
      "statusBarItem.remoteForeground"   : color.fg.default,
      "statusBarItem.remoteBackground"   : lightDark(color.scale.gray[1], color.scale.gray[9]),
