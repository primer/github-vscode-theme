...
function getTheme({ theme, name }) {
  ...
  return {
    ...
    colors: {
      ...
      "editor.inactiveSelectionBackground"  : themes({ light: "#0366d611", dark: "#3392FF22", dimmed: "#3392FF22", hc: "#3392FF22" }),
      "editor.selectionBackground"          : themes({ light: "#0366d625", dark: "#3392FF44", dimmed: "#3392FF44", hc: "#3392FF44" }),
