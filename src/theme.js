...
function getTheme({ style, name }) {
  ...
  return {
    ...
    colors: {
      ...
      "terminal.ansiBlue": pick({ light: primer.blue[4], dark: primer.blue[5] }),
      "terminal.ansiBrightBlack": pick({ light: primer.gray[3], dark: primer.gray[6] }),
      "terminal.ansiBrightBlue": pick({ light: primer.blue[3], dark: primer.blue[7] }),
      "terminal.ansiBrightCyan": pick({ light: primer.blue[3], dark: primer.blue[8] }),
      "terminal.ansiBrightGreen": pick({ light: primer.green[3], dark: primer.green[6] }),
      "terminal.ansiBrightMagenta": pick({ light: primer.purple[3], dark: primer.purple[6] }),
      "terminal.ansiBrightRed": pick({ light: primer.red[3], dark: primer.red[6] }),
      "terminal.ansiBrightWhite": pick({ light: primer.gray[2], dark: primer.gray[6] }),
      "terminal.ansiBrightYellow": pick({ light: primer.orange[3], dark: primer.orange[7] }),
      "terminal.ansiCyan": pick({ light: primer.blue[3], dark: primer.blue[6] }),
      "terminal.ansiGreen": pick({ light: primer.green[4], dark: primer.green[5] }),
      "terminal.ansiMagenta": pick({ light: primer.purple[4], dark: primer.purple[5] }),
      "terminal.ansiRed": pick({ light: primer.red[4], dark: primer.red[5] }),
      "terminal.ansiWhite": pick({ light: primer.gray[2], dark: primer.gray[7] }),
      "terminal.ansiYellow": pick({ light: primer.orange[4], dark: primer.orange[6] }),
