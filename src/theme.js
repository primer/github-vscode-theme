...
function getTheme({ theme, name }) {
  ...
  return {
    ...
    colors: {
      ...
      "list.hoverBackground"            : themes({ light: "#ebf0f4", dark: "#282e34", spacegray: "#282e34" }),
      "list.inactiveSelectionBackground": themes({ light: "#e8eaed", dark: "#282e34", spacegray: "#282e34" }),
      "list.activeSelectionBackground"  : themes({ light: "#e2e5e9", dark: "#39414a", spacegray: "#39414a" }),
      "list.inactiveFocusBackground"    : themes({ light: color.blue[1], dark: "#1d2d3e", spacegray: "#1d2d3e" }),
      "list.focusBackground"            : themes({ light: "#cce5ff", dark: color.blue[7], spacegray: color.blue[2] }),

      "tree.indentGuidesStroke": themes({ light: color.gray[2], dark: color.gray[8], spacegray: color.gray[1] }),
      ...
      "breadcrumbPicker.background"         : themes({ light: color.gray[0], dark: "#2b3036", spacegray: "#2b3036" }),
      ...
      "editorWhitespace.foreground"       : themes({ light: color.gray[3], dark: color.gray[7], spacegray: color.gray[2] }),
      ...
      "diffEditor.insertedTextBackground": themes({ light: "#34d05822", dark: "#28a74530", spacegray: "#28a74530" }),
      "diffEditor.removedTextBackground":  themes({ light: "#d73a4922", dark: "#d73a4930", spacegray: "#d73a4930" }),

      "scrollbar.shadow"                : themes({ light: "#6a737d33", dark: "#0008", spacegray: "#0008" }),
      "scrollbarSlider.background"      : themes({ light: "#959da533", dark: "#6a737d33", spacegray: "#6a737d33" }),
      "scrollbarSlider.hoverBackground" : themes({ light: "#959da544", dark: "#6a737d44", spacegray: "#6a737d44" }),
      "scrollbarSlider.activeBackground": themes({ light: "#959da588", dark: "#6a737d88", spacegray: "#6a737d88" }),
      ...
      "debugToolBar.background"                    : themes({ light: color.white, dark: "#2b3036", spacegray: "#2b3036" }),
