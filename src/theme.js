...
function getTheme({ style, name }) {
  ...
  return {
    ...
    colors: {
      ...
      "dropdown.listBackground": pick({ light: primer.gray[1], dark: "#181c1f" }),
      ...
      "titleBar.activeBackground": pick({ light: primer.gray[1], dark: "#181c1f" }),
      "titleBar.inactiveForeground": primer.gray[5],
      "titleBar.inactiveBackground": pick({ light: primer.gray[1], dark: "#161a1d" }),
      ...
      "activityBar.background": pick({ light: primer.gray[1], dark: "#181c1f" }),
      ...
      "list.hoverBackground": pick({ light: "#ebf0f4", dark: "#21262b" }),
      "list.inactiveSelectionBackground": pick({ light: "#e8eaed", dark: "#282e34" }),
      "list.activeSelectionBackground": pick({ light: "#e8eaed", dark: "#21262b" }),
      ...
      "statusBar.foreground": primer.gray[5],
      "statusBar.background": pick({ light: primer.gray[1], dark: "#181c1f" }),
      "statusBar.border": pick({ light: primer.gray[2], dark: primer.white }),
      "statusBar.noFolderBackground": pick({ light: primer.gray[1], dark: "#181c1f" }),
      ...
      "editorGroupHeader.tabsBackground": pick({ light: primer.gray[1], dark: "#161a1d" }),
      ...
      "tab.inactiveBackground": pick({ light: primer.gray[1], dark: "#161a1d" }),
      "tab.activeBackground": pick({ light: primer.gray[1], dark: "#181c1f" }),
      "tab.hoverBackground": pick({ light: primer.gray[1], dark: "#181c1f" }),
      "tab.unfocusedHoverBackground": pick({ light: primer.gray[1], dark: "#181c1f" }),
      ...
      "tab.activeBorder": pick({ light: primer.gray[1], dark: "#181c1f" }),
      ...
      "editor.background": pick({ light: primer.gray[1], dark: "#181c1f" }),
      "editorWidget.background": pick({ light: primer.gray[1], dark: "#161a1d" }),
      ...
      "panel.background": pick({ light: primer.gray[1], dark: "#161a1d" }),
