...
function getTheme({ theme, name }) {
  ...
  return {
    ...
    colors: {
      ...
      "editor.background"                 : themes({ light: scale.white, dark: scale.gray[9], dimmed: scale.gray[9] }),
      "editorWidget.background"           : themes({ light: scale.gray[1], dark: scale.gray[8], dimmed: scale.gray[8] }),
      "editor.foldBackground"             : themes({ light: scale.gray[0], dark: scale.gray[7], dimmed: scale.gray[7] }),
      "editor.lineHighlightBackground"    : themes({ light: scale.gray[1], dark: scale.gray[8], dimmed: scale.gray[8] }),
      ...
      "editorIndentGuide.background"      : themes({ light: "#eff2f6", dark: scale.gray[7], dimmed: scale.gray[7] }),
      "editorIndentGuide.activeBackground": themes({ light: "#d7dbe0", dark: scale.gray[6], dimmed: scale.gray[6] }),
      ...
      "editorGutter.modifiedBackground": themes({ light: scale.blue[4], dark: scale.blue[4], dimmed: scale.blue[4] }),
      "editorGutter.addedBackground"   : themes({ light: scale.green[5], dark: scale.green[5], dimmed: scale.green[5] }),
      "editorGutter.deletedBackground" : themes({ light: scale.red[5], dark: scale.red[4], dimmed: scale.red[4] }),
      ...
      "terminal.foreground": themes({ light: scale.gray[6], dark: scale.gray[3], dimmed: scale.gray[3] }),

      "gitDecoration.addedResourceForeground"      : themes({ light: scale.green[5], dark: scale.green[4], dimmed: scale.green[4] }),
      "gitDecoration.modifiedResourceForeground"   : themes({ light: scale.blue[6], dark: scale.blue[3], dimmed: scale.blue[3] }),
      "gitDecoration.deletedResourceForeground"    : themes({ light: scale.red[5], dark: scale.red[4], dimmed: scale.red[4] }),
      "gitDecoration.untrackedResourceForeground"  : themes({ light: scale.green[5], dark: scale.green[4], dimmed: scale.green[4] }),
      "gitDecoration.ignoredResourceForeground"    : themes({ light: scale.gray[4], dark: scale.gray[5], dimmed: scale.gray[5] }),
      "gitDecoration.conflictingResourceForeground": themes({ light: scale.orange[6], dark: scale.orange[3], dimmed: scale.orange[3] }),
      "gitDecoration.submoduleResourceForeground"  : themes({ light: scale.gray[4], dark: scale.gray[5], dimmed: scale.gray[5] }),

      "debugToolBar.background"                    : themes({ light: scale.white, dark: scale.gray[8], dimmed: scale.gray[8] }),
